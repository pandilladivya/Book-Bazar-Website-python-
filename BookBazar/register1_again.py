...
<html>
 ...
 <body>
      ...
      <td>
       ...
       <tr>       
       <td>sem*:</td>  
       <td><input type="radio" name="sem" value=0 required>0
       <input type="radio" name="sem" value=1 required>1
             <input type="radio" name="sem" value=2 required>2 <font color="red" size="4">(select 0 if first year)</font><br></td>
       </tr>
       <tr>
       <td>phone number*:</td> 
...
again="""<html>
                     <body onload="window.location='http://127.0.1.1/register1_again.py'">
                     </body>
               </html>
"""
