...
<body>
 ...
 <center>
   <fieldset>
     <legend><b><i><font size="6" color="white">Books That You Require</font></i></b></legend>
     <table width=100%>
      <tr bgcolor="red">
    ...
    try :
        ...
        for i in range(1,count+1):
            ...
            for j in range(1,5):
                ...
                print("<td><font color='violet' size='4'>"+c[key].value+"</font></td>")
            print("</tr>")
...
print("""</table>
 ...
 <input type="submit" id="pd" name="submit" value="<< SEARCH OTHER BOOK">
 </form>
 <marquee><marquee><font size="5" color="maroon">SORRY!! NO BOOKS ARE UPLOADED WITH THE CHOSEN SPECIFICATIONS....</font></marquee></marquee>
</body>
</html>
""")
...
back="""
<html>
  <body onload="window.location='http://127.0.1.1/search.py'">
  </body>
</html>
"""
